...
/**
 * This service-layer interface was designed to represent basic operations on {@link ClientHostStatistic} instances.
...
public interface ClientHostStatisticService {
	...
	/**
	 *	 Saves passed object to the database. If its database representation does not exist, this method will create it.
	 *	In other case, the method will update existing records.
	 *
	 * @param			clientHostStatistic An instance of informational container to be persist.
	 * */
