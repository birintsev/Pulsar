 ...
 * */
public class NetworkInfo2DTOConverter extends
    StdConverter<NetworkInfo, ClientHostStatisticDTO.NetworkInfoDTO> {

    @Override
    public ClientHostStatisticDTO.NetworkInfoDTO convert(NetworkInfo value) {
